...
export function mountAmadeusUi(root, hooks = {}) {
  ...
  el.innerHTML = `
    <header class="ama-statusbar"><div class="ama-brand">AMA·DEUS <span>LAB MEM 004</span></div><div class="ama-link"><i></i><span data-ama-status>STANDBY</span></div></header>
  ...
  el.addEventListener('click', async (e) => {
    ...
    else if (act === 'chat') { openSheet('chat'); setTimeout(() => chatInput.focus(), 120) }
  ...
  return { setStatus, setSubtitle, openSheet, closeSheet, loadSettings }
}
