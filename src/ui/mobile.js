...
const hasNativeSpeech = isIOS || isAndroid
...
export function mountMobileUi(root, hooks = {}) {
  ...
  shell.innerHTML = `
    ...
    <section class="mobile-sheet mobile-voice-sheet" aria-hidden="true">
      ...
      <div class="mobile-voice-status">${hasNativeSpeech ? '点击开始收音，识别后的中文会自动发送给 Amadeus。' : '当前平台暂未启用语音输入。'}</div>
